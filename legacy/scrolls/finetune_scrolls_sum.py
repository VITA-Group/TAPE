    ...
    if args.resume_from_checkpoint:
        ...
        if checkpoint_path is not None:
            ...
            if "epoch" in training_difference:
                ...
                completed_steps = int(training_difference.split("_")[1])
    ...
    for epoch in range(starting_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(active_dataloader):
            if "ape" in config.rpe_type:
                ...
                train_scale = None
            # batch = my_preprocess(batch, args.preprocess, train_scale=train_scale)
                    ...
                    for step, batch in enumerate(eval_dataloader):
                        with torch.no_grad():
                            ...
                            if "ape" in config.rpe_type:
                                ...
                                train_scale = None
                            # batch = my_preprocess(batch, args.preprocess, True, train_scale=train_scale)
                            outputs = model(**batch)
